...
description: Dispatch per-plan-task subagents with mandatory two-stage review (spec compliance then code quality). Triggers: execute plan, subagent development, dispatch tasks, implement tasks, subagent dev, agent. Requires approved plan.
---
