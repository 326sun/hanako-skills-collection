...
--- # Data Analysis Use pandas, numpy, scipy for scientific data analysis. ## Workflow 1. **Inspect**: Check shape, dtypes, missing values, duplicates. Use `.info()`, `.describe()`, `.isna().sum()`.
...
5. **Export**: Save cleaned data and results. Document all transformations. ## Constraints - Always report effect sizes alongside p-values.
