...
description: Generate Mermaid diagrams from natural language, export to PNG/SVG/PDF. Triggers: diagram, flowchart, sequence, class diagram, ER, state machine, architecture, git graph, 画图, 架构图, 流程图, 时序图. Proactive for 3+ component systems, API flows, auth sequences, class hierarchies, DB schemas, state machines.
---
