...
description: "Journal-quality scientific figures: graphical abstracts, mechanism diagrams, TOC figures. Triggers: 机制图, 图形摘要, graphical abstract, journal figure, Nature-style figure, schematic, device architecture. NOT for data charts (use data-visualization)."
---
